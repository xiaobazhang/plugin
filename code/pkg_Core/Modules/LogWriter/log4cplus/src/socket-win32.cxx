...
init_winsock ()
{
    ...
    LONG val = (LONG)::InterlockedCompareExchange (
        (PVOID*)(&winsock_state), (PVOID)WS_INITIALIZING, (PVOID)WS_UNINITIALIZED);
#else
	LONG val = ::InterlockedCompareExchange (
        static_cast<LONG volatile *>(&winsock_state), WS_INITIALIZING, WS_UNINITIALIZED);
#endif
...
#if defined(_MSC_VER) && _MSC_VER <= 1200 // VC6
            val = (LONG)::InterlockedCompareExchange (
                (PVOID*)(&winsock_state), (PVOID)WS_UNINITIALIZED, (PVOID)WS_INITIALIZING);
#else
			val = ::InterlockedCompareExchange (
                static_cast<LONG volatile *>(&winsock_state), WS_UNINITIALIZED, WS_INITIALIZING);
#endif
